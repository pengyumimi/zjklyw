      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            ...
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">景点所属地区:</label>
              <div class="col-sm-5">
                <select class="form-control" name="catid">
                      
                    <?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$vo): ?><option value="<?php echo ($vo["menu_id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                   <!--<?php if(is_array($webSiteMenu1)): $i = 0; $__LIST__ = $webSiteMenu1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["id"]); ?>" <?php if($vo["id"] == $menus["pid"] ): echo (str_repeat('&emsp;',$vo["level"]*2)); endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>-->
                </select>
              </div>
            </div>
...
<script>
  var SCOPE = {
    'save_url' : '/admin.php?c=Alljd&a=jdadd',
    'jump_url' : '/admin.php?c=Alljd',
