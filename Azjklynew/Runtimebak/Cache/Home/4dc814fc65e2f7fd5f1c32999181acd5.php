 ...
 if (homeLoginUsername()){ ?>
	...
	<div class="main_box">
		...
		<div class="listzty_tab">
			...
			<a href="<?php echo U('Zhuti/yaog');?>"><span class="selected">摇滚</span></a>
		</div>
		</section>
		<section>
			<!--左侧列表-->
			<div class="common_list left">
			<?php if(is_array($result['yaog'])): $i = 0; $__LIST__ = $result['yaog'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_item">
                    ...
                    <div class="img_box">
						<span class="tag_1">摇滚</span><!--区别标签如果没有类别标签就不需要加-->
