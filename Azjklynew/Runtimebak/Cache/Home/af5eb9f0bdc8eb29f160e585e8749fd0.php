 ...
 if (homeLoginUsername()){ ?>
	...
	<div class="main_box">
		...
		<div class="listzty_tab">
			...
			<a href="<?php echo U('Zhuti/meis');?>"><span class="selected">美食</span></a>
		...
		<section>
			...
			<?php if(is_array($result['meis'])): $i = 0; $__LIST__ = $result['meis'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_item">
                    ...
                    <div class="img_box">
						<span class="tag_1">美食</span><!--区别标签如果没有类别标签就不需要加-->
