          ...
          <div class="col-md-3">
            <div class="input-group">
              ...
              <select class="form-control" name="catid">
                <option value='' >景点全览</option>
                <?php if(is_array($jdqlMenu)): foreach($jdqlMenu as $key=>$sitenav): ?><option value="<?php echo ($sitenav["menu_id"]); ?>" ><?php echo ($sitenav["name"]); ?></option><?php endforeach; endif; ?>
              </select>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <form id="singcms-listorder">
              <table class="table table-bordered table-hover singcms-table">
                ...
                <tbody>
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo (getCatName($jdqlMenu,$new["catid"])); ?></td>
...
<script>
  var SCOPE = {
    'edit_url' : '/admin.php?c=Alljd&a=edit',
    'add_url' : '/admin.php?c=Alljd&a=jdadd',
    'set_status_url' : '/admin.php?c=Alljd&a=setStatus',
    'sing_news_view_url' : '/index.php?c=view',
    'listorder_url' : '/admin.php?c=Alljd&a=listorder',
    'push_url' : '/admin.php?c=Alljd&a=push',
  }
</script>
