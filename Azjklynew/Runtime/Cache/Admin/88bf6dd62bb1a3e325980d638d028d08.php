        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="catid">
                    ...
                    <!--<?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$sitenav): ?><option value="<?php echo ($vo["menu_id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>-->
                   <?php if(is_array($webSiteMenu)): $i = 0; $__LIST__ = $webSiteMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!-- <option value="<?php echo ($vol["id"]); ?>" <?php if($vo["id"] == $menus["pid"] ): echo (str_repeat('&emsp;',$vo["level"]*2)); endif; ?>><?php echo ($vo["name"]); ?></option>-->
                  <option value="<?php echo ($vo["menu_id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                  <input type="text" class="form-control" name="hdtime" id="inputPassword3" placeholder="活动时间">
              </div>
               <label for="inputPassword3" class="col-sm-2 control-label">包含项目:</label>
              <div class="col-sm-9">
                  <input type="text" class="form-control" name="bhxm" id="inputPassword3" placeholder="包含项目">
              </div>
               <label for="inputPassword3" class="col-sm-2 control-label">不包含项目:</label>
              <div class="col-sm-9">
                  <input type="text" class="form-control" name="bbhxm" id="inputPassword3" placeholder="不包含项目">
              </div>
            </div>
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">行程概况:</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="keywords" id="inputPassword3" placeholder="请填写行程概况">
              </div>
            </div>
              <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">参团人数:</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="ctrs" id="inputPassword3" placeholder="请填写参团人数">
              </div>
            </div>
              <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">好评率:</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="goodp" id="inputPassword3" placeholder="请填写好评率">
              </div>
            </div>
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">价格:</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="price" id="inputPassword3" placeholder="请填写好评率">
              </div>
            </div>
