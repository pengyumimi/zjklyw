        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="copyfrom">
                     <?php if(is_array($copyfrom)): foreach($copyfrom as $key=>$cfrom1): ?><option value="<?php echo ($key); ?>" <?php if($key == $news['copyfrom']): ?>selected="selected"<?php endif; ?>><?php echo ($cfrom1); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                  <input value="<?php echo ($news["hdtime"]); ?>"type="text" class="form-control" name="hdtime" id="inputPassword3" placeholder="描述">
              </div>
               <label for="inputPassword3" class="col-sm-2 control-label">包含项目:</label>
              <div class="col-sm-9">
                  <input value="<?php echo ($news["bhxm"]); ?>"type="text" class="form-control" name="bhxm" id="inputPassword3" placeholder="描述">
              </div>
               <label for="inputPassword3" class="col-sm-2 control-label">不包含项目:</label>
              <div class="col-sm-9">
                  <input value="<?php echo ($news["bbhxm"]); ?>"type="text" class="form-control" name="bbhxm" id="inputPassword3" placeholder="描述">
              </div>
            </div>
            <div class="form-group">
             ...
             <div class="form-group"> 
              ...
              <div class="col-sm-5">
                <input value="<?php echo ($news["ctrs"]); ?>" type="text" class="form-control" name="ctrs" id="inputPassword3" placeholder="请填写关键词">
              </div>
            </div>
             <div class="form-group"> 
                <label for="inputPassword3" class="col-sm-2 control-label">好评率:</label>
              <div class="col-sm-5">
                <input value="<?php echo ($news["goodp"]); ?>" type="text" class="form-control" name="goodp" id="inputPassword3" placeholder="请填写关键词">
              </div>           
                </div>
                <div class="form-group"> 
                 <label for="inputPassword3" class="col-sm-2 control-label">价格:</label>
              <div class="col-sm-5">
                <input value="<?php echo ($news["price"]); ?>" type="text" class="form-control" name="price" id="inputPassword3" placeholder="请填写参团人数">
              </div>
                </div>
