 ...
 if (homeLoginUsername()){ ?>
	...
	<div class="main_box">
		...
		<div class="listzty_tab">
			...
			<a href="<?php echo U('Zhuti/xinl');?>"><span class="selected">心灵</span></a>
		...
		<section>
			...
			<?php if(is_array($result['xinl'])): $i = 0; $__LIST__ = $result['xinl'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_item">
                    ...
                    <div class="img_box">
						<span class="tag_1">心灵</span><!--区别标签如果没有类别标签就不需要加-->
